...
Оговорка про остальное: раскладка секций и стили отдельных блоков в
репозитории **отстают** от того, что описано здесь, пока не залита текущая
работа. Токены, шрифты и ассеты — совпадают, им верить можно; за разбивкой
секций на светлые и тёмные идите в раздел 3.5 этого файла, а не в код
репозитория.
...
Файл необязательный: без него достаточно двух радиальных пятен.
