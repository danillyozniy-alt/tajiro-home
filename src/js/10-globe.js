...
(function () {
  ...
  /* --- Палитра ------------------------------------------------------------
     Держим здесь, а не читаем из CSS каждый кадр: канвасу нужны числа, а
     getComputedStyle на кадре — это принудительный пересчёт стилей. */
  /* Тёмное по светлому: шар живёт прямо на кремовом фоне секции, без
     отдельной подложки. Светлые точки, которые работали на тёмной плашке,
     на кремовом исчезали — здесь наоборот, глубина набирается плотностью
     тёмного, а не свечением. */
  var LAND  = '35, 74, 54';      /* контуры материков */
  var GRID  = '61, 143, 99';     /* меридианы и параллели */
  var ARC   = '35, 74, 54';      /* дуги заказов */
  var STORE = '134, 91, 42';     /* маркер магазина — золото на зелёном */
